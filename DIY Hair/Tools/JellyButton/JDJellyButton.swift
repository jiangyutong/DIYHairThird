...
class JDJellyButton
{
    ...
    init() {
       Container = JelllyContainer(frame: CGRect(x: 120, y: -150, width: 400, height: 400))
    }
...
extension JDJellyButton:JellyButtonDelegate
{
    func JellyButtonHasBeenTap(touch:UITouch,image:UIImage,groupindex:Int,arrindex:Int)
    {
        ...
        myUIC?.performSegue(withIdentifier: "jytpseg", sender: nil)
    }
